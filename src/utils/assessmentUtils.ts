...
// Utility functions for generating assessment results and insights

// Function to generate relevant strengths based on assessment type and responses
export const generateRelevantStrengths = (assessmentType: string | null, formData: any) => {
...
export const generateRelevantOpportunities = (assessmentType: string | null, formData: any) => {
...
export const generateRelevantRecommendations = (assessmentType: string | null, formData: any) => {
...
export const calculateAssessmentScore = (formData: any) => {
