...
const BoardService = () => {
  ...
  return (
    <section id="board-service" className="section-padding bg-gradient-to-br from-white to-gray-50">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
            {services.map((service, index) => {
              ...
              return (
                <div key={index} className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-stratified-light group">
          ...
          <div className="bg-gradient-to-r from-stratified-lighter/50 to-stratified-light/50 rounded-2xl p-6 md:p-8 mb-12 border border-stratified-lighter/30 shadow-lg">
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-stratified mb-2">10+</div>
