          ...
          >
            ...
            <ScrollArea className="h-full pt-20 md:pt-24">
              <div className="pb-16">
                <div className="border-b border-border bg-muted/20 px-6 md:px-12 py-12 md:py-16">
                  <div className="max-w-4xl mx-auto flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
                    ...
                    <div className="flex-1">
                      <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl text-stratified mb-4 leading-tight">
                        {member.name}
                      </h1>
                      <p className="text-body-lg text-foreground/90 mb-4">{member.title}</p>
                      <div className="flex items-center text-muted-foreground text-base mb-8">
                ...
                <div className="max-w-4xl mx-auto px-6 md:px-12 py-12 space-y-14">
                  <section>
                    <h2 className="font-heading text-stratified text-xl md:text-2xl mb-6 border-b border-border pb-3">
                      About
                    </h2>
