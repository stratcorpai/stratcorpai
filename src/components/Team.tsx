      ...
      <div className="container-custom">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 bg-white rounded-xl shadow-lg p-8 transform transition-all duration-300 hover:shadow-xl">
            <h4 className="text-xl font-semibold mb-6 text-stratified">Board-Ready Expertise & Value</h4>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="p-4 bg-gray-50 rounded-lg hover:bg-stratified/5 transition-colors">
                <h5 className="font-semibold mb-2 text-stratified">PE Portfolio Acceleration</h5>
                <p className="text-gray-700 text-sm">
                  Go-to-market, founder advisory, and post-deal transformation expertise for scale-up success.
                </p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg hover:bg-stratified/5 transition-colors">
              ...
              <div className="p-4 bg-gray-50 rounded-lg hover:bg-stratified/5 transition-colors">
                ...
                <p className="text-gray-700 text-sm">
                  Bridging national digital policy with commercial scale, including EU AI Act contributions.
                </p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg hover:bg-stratified/5 transition-colors">
                <h5 className="font-semibold mb-2 text-stratified">Strategic Planning & Investment</h5>
                <p className="text-gray-700 text-sm">
                  Enterprise-scale opportunity assessment with market entry frameworks and investment governance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-stratified-lighter/30 rounded-xl p-6 text-center">
            ...
            <p className="text-gray-700 mb-4">Scale-up boards in enterprise SaaS, AI, or regulated markets (Series B–D) • Operating partner/advisor to PE or VC funds • Innovation, AI, ESG, or GTM-focused board committees</p>
          </div>
        </div>
      </div>
    </section>
